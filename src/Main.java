...
public class Main
{
    public static void main(String[] args) throws FileNotFoundException, IOException
    {
        ...
        // Resolve dependencies
           ...
           Scene.v().loadClassAndSupport("Example");
           
           Body b;
           System.out.println(b = Scene.v().getSootClass("Example").getMethods().get(2).retrieveActiveBody());
           System.out.println(b.getLocals().getFirst().getType());
